...
//
//public class CustomAdapterSanPhamGioHang extends ArrayAdapter {
//    Context context;
//    int resource;
//    List<SanPham> data;
//    public CustomAdapterSanPhamGioHang(@NonNull Context context, int resource, List<SanPham> data) {
